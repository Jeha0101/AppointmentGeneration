 ...
 * Use the [DestinationFirstFragment.newInstance] factory method to
...
class DestinationFirstFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DestinationFirstFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DestinationFirstFragment().apply {
